...
Minitest reporter plugin for Circle CI
...
In order to use this gem, add it to your Gemfile:
    ...
    gem "minitest-cli", :github => "circleci/minitest-ci"
...
TESTOPS.  On CircleCI, you might want to use something like this in your
circle.yml:
